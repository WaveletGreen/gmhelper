...
import org.encryption.gmhelper.BCECUtil;
import org.encryption.gmhelper.SM2Util;
import org.encryption.gmhelper.util.util.FileUtil;
...
public class SM2UtilTest extends GMBaseTest {
    ...
    @Test
    public void testSignAndVerify() throws CryptoException, IOException {
     ...
     */
    @Test
    public void testEncryptAndDecrypt() throws InvalidCipherTextException {
        AsymmetricCipherKeyPair keyPair = SM2Util.generateKeyPairParameter();
        ECPrivateKeyParameters priKey = (ECPrivateKeyParameters) keyPair.getPrivate();
        ECPublicKeyParameters pubKey = (ECPublicKeyParameters) keyPair.getPublic();
    ...
    @Test
    public void testEncryptAndDecrypt_C1C2C3() throws InvalidCipherTextException {
        AsymmetricCipherKeyPair keyPair = SM2Util.generateKeyPairParameter();
        ECPrivateKeyParameters priKey = (ECPrivateKeyParameters) keyPair.getPrivate();
        ECPublicKeyParameters pubKey = (ECPublicKeyParameters) keyPair.getPublic();
    ...
    @Test
    public void testEncodeSM2CipherToDER() throws Exception {
        AsymmetricCipherKeyPair keyPair = SM2Util.generateKeyPairParameter();
        ECPrivateKeyParameters priKey = (ECPrivateKeyParameters) keyPair.getPrivate();
        ECPublicKeyParameters pubKey = (ECPublicKeyParameters) keyPair.getPublic();
    ...
    @Test
    public void testEncodeSM2CipherToDER_C1C2C3() throws Exception {
        AsymmetricCipherKeyPair keyPair = SM2Util.generateKeyPairParameter();
        ECPrivateKeyParameters priKey = (ECPrivateKeyParameters) keyPair.getPrivate();
        ECPublicKeyParameters pubKey = (ECPublicKeyParameters) keyPair.getPublic();
    ...
    @Test
    public void testGenerateBCECKeyPair() throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException, CryptoException {
