package org.encryption.international.util;

import org.encryption.international.common.EncType;
import org.encryption.international.common.SecureType;
import org.encryption.international.common.SignAlgorithm;
import org.encryption.international.secure.RSAPrivateSecure;
import org.encryption.international.secure.RSAPublicSecure;
import org.encryption.international.secure.SecureFactory;
...
public class SignatureUtils {
    ...
    public static String getSignRSA(String value, String privateKey) {
        return getSignRSA(value, privateKey, SignAlgorithm.SHA256WithRSA, EncType.BASE64, EncType.BASE64);
    }
     ...
     * @return
     */
    public static String getSignRSA(String value, String privateKey, SignAlgorithm type) {
    ...
    public static String getSignRSA(String value, String privateKey, EncType contentEncType, EncType keyEncType) {
        return getSignRSA(value, privateKey, SignAlgorithm.SHA256WithRSA, contentEncType, keyEncType);
    }
     ...
     * @return
     */
    public static String getSignRSA(String value, String privateKey, SignAlgorithm type, EncType contentEncType, EncType keyEncType) {
    ...
    public static boolean verify(String value, String publicKey, String sign) {
        return verify(value, publicKey, sign, SignAlgorithm.SHA256WithRSA, EncType.BASE64, EncType.BASE64);
    }
     ...
     * @return
     */
    public static boolean verify(String value, String publicKey, String sign, SignAlgorithm type) {
    ...
    public static boolean verify(String value, String publicKey, String sign, EncType contentEncType, EncType keyEncType) {
        return verify(value, publicKey, sign, SignAlgorithm.SHA256WithRSA, contentEncType, keyEncType);
    }
     ...
     * @return
     */
    public static boolean verify(String value, String publicKey, String sign, SignAlgorithm type, EncType contentEncType, EncType keyEncType) {
        byte[] data = value.getBytes();
