...
public class RSAPublicSecure extends BaseSecure {
    ...
    public PublicKey getPublicKey(String publicKey) throws Exception {
        ...
        byte[] decode = decode(publicKey, getKeyEncType());
    ...
    public byte[] encrypt(byte[] data) throws Exception {
        ...
        // 对数据分段加密
        CoderUtil.doSection(cipher, data, out, MAX_ENCRYPT_BLOCK);
    ...
    public byte[] decrypt(byte[] data) throws Exception {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        // 对数据分段解密
        CoderUtil.doSection(cipher, data, out, MAX_DECRYPT_BLOCK);
    ...
    public boolean verify(byte[] data, String signData) {
        return verify(data, signData, SignAlgorithm.SHA256WithRSA);
    }
     ...
     * @throws Exception
     */
    public boolean verify(byte[] data, String signData, SignAlgorithm signAlgorithm) {
        try {
